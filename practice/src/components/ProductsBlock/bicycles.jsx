    ...
    return (
        <section>
            ...
            <div className={styles.bicycles}>
                <div className={styles.bicycles_title}>SEGWAY Ninebot Kickscooter MAX</div>
                <img src={MAXG30E} alt="MAXG30E" className={styles.slider} />
                <div className={styles.SegwayProtective}>
                    <div className={styles.SegwayProtective_textBlock}>
                        <div className={styles.SegwayProtective_title}>
                            SEGWAY PROTECTIVE GEAR SET AS <span style={{ color: '#009EFF' }}>A GIFT</span>
                        </div>
                        <div className={styles.SegwayProtective_text}>
                            The cost of a protection kit when buying a scooter is
                            $0 instead of $29.99
                        </div>
                    </div>
                    <img src={PriceBlock} alt="PriceBlock" className={style.price_img} />
